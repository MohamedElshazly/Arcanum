...
export const BIOMES: Record<BiomeType, BiomeDefinition> = {
  stone: {
    ...
    ambientLightColor: '#ffffff', ambientLightIntensity: 1.3,
    fogColor: '#0a0a0a', fogDensity: 0.005,
  ...
  fire: {
    ...
    ambientLightColor: '#ff8844', ambientLightIntensity: 1.2,
    fogColor: '#1a0500', fogDensity: 0.008,
  ...
  ice: {
    ...
    ambientLightColor: '#aaddff', ambientLightIntensity: 1.2,
  ...
  lightning: {
    ...
    ambientLightColor: '#ccccff', ambientLightIntensity: 1.4,
  ...
  arcane: {
    ...
    ambientLightColor: '#aa66ff', ambientLightIntensity: 1.2,
  ...
  void: {
    ...
    ambientLightColor: '#440022', ambientLightIntensity: 1.1,
    fogColor: '#050005', fogDensity: 0.01,
    dominantElement: null,
    enemyElementWeights: { fire: 0.25, ice: 0.25, lightning: 0.25, arcane: 0.25 },
    hazards: [
